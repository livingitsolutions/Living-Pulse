import { addSuppression, assertEmailAvailable, assertQueueEligible, createProspect as validateProspect, normalizeEmail, qualify, reject, transitionOutreach, type Prospect, type ProspectInput, type SuppressionReason } from './acquisitionFoundation'
  ...
  return {
    ...
    async createProspect(input: ProspectInput) {
      ...
      return store.transaction(async (tx) => {
        ...
        await tx.insertAudit('prospect_created', saved.id)
        return saved
      })
    },

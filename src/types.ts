...
export type EventName = 'landing_viewed' | 'create_started' | 'pulse_created' | 'pulse_published' | 'pulse_link_copied' | 'qr_downloaded' | 'public_pulse_viewed' | 'response_started' | 'response_completed' | 'update_opt_in' | 'results_viewed' | 'second_pulse_created'
